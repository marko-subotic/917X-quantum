...
private:
    ...
    static constexpr double kLookAhead = .25;
    static constexpr double maxLookAhead = 30;
    static constexpr double linSpd = 5;
    static constexpr double AngleWhenDecelerate [2] = { 179 * M_PI / 180, 70  * M_PI / 180 };
    static constexpr double AngleUntilLinear[2] = { 178.9 * M_PI / 180, 20 * M_PI / 180 };
    static constexpr double oSpeed[2] = { 100, 100};
    static constexpr double kOsc[2] = { .25, .5 };
